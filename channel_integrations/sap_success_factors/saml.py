...
def _build_saml_assertion(
    ...
    assertion = etree.Element(
        ...
        nsmap={'ds': XMLDSIG_NAMESPACE, 'saml': SAML_ASSERTION_NAMESPACE, 'xsi': XSI_NAMESPACE},
    )
...
def generate_saml_assertion(
    ...
    Raises:
        InvalidAssertionParameterError: If client_id, user_id, audience, or token_url is
            missing, or if token_url is not an absolute HTTPS URL.
    ...
    """
    _validate_assertion_parameters(client_id, user_id, audience, token_url)
